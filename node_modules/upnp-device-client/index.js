    ...
    var req = http.request(options, function(req) {
      req.pipe(concat(function(buf) {
        ...
        if(req.statusCode !== 200) {
			console.log("request statuscode is ", req.statusCode, " and is not 200");
...
function parseEvents(buf) {
  var events = [];
  var doc = et.parse(cleanString(buf.toString()));
	console.log("Parse-event buffer");
	console.log((cleanString(buf.toString())));
  ...
  if(lastChange) {
	...
	console.log("there was a lastChange found");
